				...
				function()
					...
					elseif boss_phase==2 or boss_phase==3 then
						return self:promise_sequence(
							...
							function()
								if hard_mode then
									spawn_reflection(ternary(player and player.x<40,1,-1),
										10,
										"throw_hat",
										30,
										"die")
...
010600003405032051340513255434514325143452432524345243252434524325243451432514305000050000500005000050000500005000050000500005000050000500005000050000500005000050000500
